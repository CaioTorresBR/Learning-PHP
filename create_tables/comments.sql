CREATE TABLE comments (
    ...
    # ON DELETE NO ACTION ->  default, will make no action happen if we delete an user
    # ON DELETE CASCADE -> will delete any comment created by an user, if the user is deleted
    # ON DELETE SET NULL -> will set the users_id null in case an user is deleted
);